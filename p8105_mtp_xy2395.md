...
The final dataset has 473760 observations and 6 variables. The `activity` variable contains all the activity counts in each minute. Variables `day`, `minute`, `hour`, `day_num` and `hour` colletively specify the time when each observation was made.
...
```
    ...
    ## Picking joint bandwidth of 2440
